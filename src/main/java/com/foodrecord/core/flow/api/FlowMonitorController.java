...
public class FlowMonitorController {
    ...
    public FlowMonitorController(FlowEngine flowEngine, FlowMonitor flowMonitor, FlowPerformanceAnalyzer performanceAnalyzer, FlowVisualizer flowVisualizer, @Qualifier("flowExecutionRepository") FlowExecutionRepository executionRepository) {
